package com.example.isabe.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openApi() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Isa backend app team 39")
                        .description("Pokrecemo, i molimo se da radi!")
                        .version("v1.0")
                        .contact(new Contact()      // kontakt informacije
                                .name("Dusan Janosevic")
                                .url("https://github.com/JanosevicRa177")     // mora biti u url formatu
                                .email("dusan.janosevic123@gmail.com"))
                        .termsOfService("TOC")
