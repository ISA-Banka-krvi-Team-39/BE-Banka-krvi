...
public class UpdateUserDTO {
    ...
    public UpdateUserDTO(String email, String name, String surname, String password, PersonType personType, PersonGender personGender, Address address, String uuid, String phoneNumber, String school) {
        this.email = email;
        this.name = name;
